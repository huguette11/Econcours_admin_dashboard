...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php include("alerts/alert_trajet.php") ?>
        <!-- Content Wrapper -->
                    ...
                    <div class="container-fluid">
                        <div class="header-body">
                            <div class="row align-items-center py-4">
                                <div class="text-left">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ajouter_trajet">Ajouter un trajet <i class="fa  fa-plus "></i></button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-header border-0">
                                    <h3 class="mb-0">Liste des trajets</h3>
                                </div>
                                <!-- Light table -->
    ...
    <script type="text/javascript" src="DataTables/data_table_trajet.js?version=1.0"></script>
    <script src="assets/js/script.js"></script>
    <?php include('modals/modal_trajet.php'); ?>
