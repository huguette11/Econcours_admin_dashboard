...
<head>
    ...
    <title>BITRAVEL - Reservations</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php include("alerts/alert_reservation.php") ?>
        <!-- Content Wrapper -->
                    ...
                    <div class="container-fluid">
                        <div class="header-body">
                            <div class="row align-items-center py-4">
                                <div class="text-left">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ajouter_reservation">Ajouter une réservation <i class="fa  fa-plus "></i></button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Date du voyage</th>
    ...
    <script type="text/javascript" src="DataTables/data_table_reservation.js?version=1.0"></script>
    <script src="assets/js/script.js"></script>
    <?php include('modals/modal_reservation.php'); ?>
