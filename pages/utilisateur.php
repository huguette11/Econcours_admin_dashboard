...
?>
    ...
    <body id="page-top">
                            ...
                            <div class="container-fluid">
                                <div class="header-body">
                                    <div class="row align-items-center py-4">
                                        ...
                                        <div class="text-left">
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ajouter_utilisateur">Ajouter un utilisateur <i class="fa  fa-plus "></i></button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript" src="DataTables/data_table_utilisateur.js?version=1.0"></script>
