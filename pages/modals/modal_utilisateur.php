<div class="modal fade" id="ajouter_utilisateur" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Ajout d'un nouvel utilisateur</h5>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="date_naissance" class="form-control" type="date" name="date_naissance" placeholder="Entrer la date de naissance" required>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="username" class="form-control" type="text" name="username" placeholder="Entrer le nom d'utilisateur"  required>
                            </div>

                            <div class="col-md-3">
                                <label for="password">Mot de passe (*)</label>
                                <input id="password" class="form-control" type="password" name="password" placeholder="Entrer le mot de passe" required>        
                            </div>
                        </div>
...
<div class="modal fade" id="modifier_utilisateur" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="../api/modules/modifier_utilisateur.php" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <input id="id_utilisateur" type="hidden" class="form-control"  name="id_utilisateur"  >
