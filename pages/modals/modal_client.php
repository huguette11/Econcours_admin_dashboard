<div class="modal fade" id="ajouter_client" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label for="num_cnib">Numéro CNIB/Passport</label>
                                <input id="num_cnib" class="form-control" type="text" name="num_cnib" placeholder="Entrer le numéro CNIB/Passport" >
                            </div>    
