...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php include("alerts/alert_chauffeur.php") ?>
        <!-- Content Wrapper -->
                    ...
                    <div class="container-fluid">
                        <div class="header-body">
                            <div class="row align-items-center py-4">
                                <div class="text-left">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ajouter_chauffeur">Ajouter un chauffeur <i class="fa  fa-plus "></i></button>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript" src="DataTables/data_table_chauffeur.js?version=1.0"></script>
    <script src="assets/js/script.js"></script>
    <?php include('modals/modal_chauffeur.php'); ?>
